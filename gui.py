from tkinter import*
from PIL import Image,ImageTk  #this package used to allow diffrent files like png,pdf exc..becoz by default python only allow zip files
import action
import spech_to_text


root=Tk()
root.title("AI Assistant") #To change the title
root.geometry("550x675") #To fix the size but we can resize after execution
root.resizable(False,False) #To avoid resizable 
root.config(bg="#6F8FAF") #For background color
